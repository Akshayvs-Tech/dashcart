...
import { useAddProduct, useCategories } from '@/lib/hooks/use-api';
    ...
    <div className="min-h-screen relative overflow-hidden bg-linear-to-br from-blue-50/50 via-white to-indigo-50/30">
      ...
      <div className="relative z-10 px-6 py-8 space-y-6 max-w-4xl mx-auto">
        ...
        >
          ...
          <div>
            <h1 className="text-4xl font-bold bg-linear-to-r from-blue-600 via-indigo-600 to-blue-700 bg-clip-text text-transparent">Add New Product</h1>
            <p className="text-blue-700/70 mt-1 text-lg">
